...
public class EndogenousUrn extends AbstractUrn {
	  ...
	  public EndogenousUrn(int maxBallType, int numBallsOfEachType, boolean ones) {
	    if (ones) {
	      int numBalls = maxBallType * numBallsOfEachType;
	  ...
	  public boolean hasBall(int x, int y, Integer ball) {
	    return ballSet.containsKey(ball);
	  }
	  ...
	  public String toString() {
	    StringBuffer b = new StringBuffer("EndogenousUrn:\n");
